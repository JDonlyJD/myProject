...
<script type="text/javascript">
   ...
   $(function(){
      ...
      //***이벤트1 ) 이미지 수정버튼을 눌렀을 때 
      $('#photo_btn').click(function(){
         $('#photo_choice').show(); //안보여지는 것을 보여지게 변경
         $(this).hide(); //수정 버튼 감추기
      });
   
      //***이벤트2 ) 이미지 취소버튼을 눌렀을 때 : 이미지 미리보기 취소
      $('#photo_reset').click(function(){
         //이미지 미리보기 전 이미지로 되돌리기(보관 후 사용)
         $('.my-photo').attr('src',photo_path); //취소하면 원래 이미지(???????)로 변경
...
<div class="page-main">
   ...
   <ul>
      ...
      <li>
         ...
         <img src="${pageContext.request.contextPath}/images/emptyitem.png" 
